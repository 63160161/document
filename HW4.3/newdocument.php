...
<head>
    ...
    <div class="container">
        <h1 align =left >Add an document</h1>
        <form action="newdocument.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="doc_num" style='color:#35589A;'>เลขที่คำสั่ง</label>
                <input type="text" class="form-control" name="doc_num" id="doc_num" style="background-color:#DFF6FF" onkeyup="checkdocnum()">
                <h3><div id = "disp"></div></h3>
            </div>
            <div class="form-group">
                <label for="doc_title"style='color:#35589A;'>ชื่อคำสั่ง</label>
                <input type="text" class="form-control" name="doc_title" id="doc_title" style="background-color:#DFF6FF">
            </div>
            <div class="form-group">
                <label for="doc_start_date"style='color:#35589A;'>วันที่เริ่มต้นคำสั่ง</label>
                <input type="date" class="form-control" name="doc_start_date" id="doc_start_date" style="background-color:#DFF6FF">
            </div>
            <div class="form-group">
                <label for="doc_to_date"style='color:#35589A;'>วันที่สิ้นสุด</label>
                <input type="date" class="form-control" name="doc_to_date" id="doc_to_date" style="background-color:#DFF6FF">
            </div>
            <div class="form-group">
                <label for="doc_status"style='color:#35589A;'>สถานะ</label>
